...
Before reviewing, always load context as defined in `cortex/commands/4-review.md` — read local knowledge files directly, and query linked repos if `.cortex-repos.json` is non-empty.
